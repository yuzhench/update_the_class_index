            ...
            for(int x = 0; x < sz.width; x++)
            {
                ...
                else
                {
                    ...
                    std::vector<cv::Vec3b> colors = {
                        cv::Vec3b(0, 0, 0),     // 0 red<<------------ground 
                        cv::Vec3b(255,0,50),     // 1 green<<------------sylinder
                        cv::Vec3b(255, 0, 255),     // 2 blue
                        cv::Vec3b(255, 255, 0),   // 3 yellow
                        cv::Vec3b(10,10,255),   // 4 magenta<<--------------wood board
                        ...
                        cv::Vec3b(0, 70, 90),     // 42
                        cv::Vec3b(0, 225, 0),    //43 dark magenta<------------------------switch to index 28  
